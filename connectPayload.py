...
class ConnectPayload(payload.Payload):
    ...
    def __init__(self, buffer = None, subport = 0, seqno = 0, command = 0, fnum = 0, nfrags = 0, service = None):
        super(ConnectPayload, self).__init__(buffer, subport, seqno, command, fnum, nfrags)
        if buffer is None:
